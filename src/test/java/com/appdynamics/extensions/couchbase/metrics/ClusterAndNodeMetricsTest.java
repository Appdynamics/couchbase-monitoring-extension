...
public class ClusterAndNodeMetricsTest{
    ...
    public void init() throws IOException{
        ...
        entity.setContent(new FileInputStream("src/test/resources/ClusterNode.json"));
    }
    ...
    public void clusterAndNodeMetricsTest() throws IOException{
        ...
        CouchBaseMonitorTask.serverURL = "dummy";
        ClusterAndNodeMetrics clusterAndNodeMetrics = new ClusterAndNodeMetrics(latch);
